...
We develop a software test platform using WebXR Device API to perform human perceptual experiments on VR or AR HMDs in an immersive environment. This tool can be loaded on an HMD web browser that supports WebXR. 
